...
function headOptions() {
   ...
   // NY
    document.head.classList.add('oldvk-ny-' + getRandomInt(1, 17).toString())
	// NY-martha
    document.head.classList.add('oldvk-8_martha-' + getRandomInt(1, 8).toString());
	// NY-XB
    document.head.classList.add('oldvk-XB-' + getRandomInt(1, 1).toString());
	// NY1
    document.head.classList.add('oldvk-ny-' + getRandomInt(18, 19).toString());
...
var LocalizedContent = {
    ...
    updateMenu: function () {
		...
		document.querySelector('#l_aud .left_row').setAttribute('href', '/audio?section=all');
