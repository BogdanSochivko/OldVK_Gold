...
$(document).scroll(function() {
   ...
   if (top_scroll > x) {
      $('#l_msg>.vkitLeftMenuItem__item--qlG6N>.left_fixer>.left_count_wrap.fl_r').css({'position':'fixed','background':'none','transition': 'background-color 0ms linear, color 0ms linear','top':'9px','color':'#9FACB5','margin-right':'263px','right':'50vw'});
   }
   else {
      $('#l_msg>.vkitLeftMenuItem__item--qlG6N>.left_fixer>.left_count_wrap.fl_r').css({'position':'relative','background':'#d1d9e0','transition': 'background-color 200ms linear, color 200ms linear','top':'0','right':'inherit','color':'#5b6e85','margin-right':'1px'});
   }
   if (top_scroll > x) {
   ...
   if (top_scroll > x) {
      $('#l_msg>.vkitLeftMenuItem__item--qlG6N>.mini_bar_icon').css({'display':'block','position':'fixed','top':'15px','margin-right':'252px','right':'50vw'});
   }
   else {
      $('#l_msg>.vkitLeftMenuItem__item--qlG6N>.mini_bar_icon').css({'display':'none'});
   }
   if (top_scroll > x) {
...
$('#l_msg>.vkitLeftMenuItem__item--qlG6N').append('<div class="mini_bar_icon">');
